...
void BaseApplication::createFrameListener(void)
{
    ...
    //mTrayMgr->showFrameStats(OgreBites::TL_BOTTOMLEFT); //commented out by Neal
    //mTrayMgr->showLogo(OgreBites::TL_BOTTOMRIGHT); //commented out by Neal
